  ...
  return (
    <div className="p-4 bg-[#202c33] border-b border-[#2a3942] flex items-center justify-between">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-1 overflow-hidden max-w-[15rem] truncate">
          <div className="font-semibold text-lg">Alhamdulilah ❤️</div>
          <div className="text-gray-400 text-sm truncate">
            Abdul, Adnan, Ahsan, Arsalan, Ayaz, Fahad, Faizan, etc.
          </div>
        </div>
      </div>
      <div className="flex items-center space-x-4">
        <button className="p-2 bg-[#2a3942] rounded-full">
          <svg
            viewBox="0 0 24 24"
            height="24"
            width="24"
